...
Route::resource('port',App\Http\Controllers\PortController::class);
/*
...
/*
Route::get('/generate-pdf/{ID_PORT}', PortController::class.'@generatePDF')->name('port.pdf');*/
// Définition de la route pour générer le PDF des ports
Route::get('/ports/pdf/{ID_PORT}', [PortController::class, 'generatePDF'])->name('port.pdf');
